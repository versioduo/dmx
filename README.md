...
An optional Ableton Max4Live device allows the the direct mapping from
Live Automation to DMX values. To avoid inconsistencies it will monitor
the Live transport state, and update all configured DMX channels of the
current device every time _Play_ or _Stop_ are triggered.
